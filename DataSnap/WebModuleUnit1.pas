...
type
  TWebModule1 = class(TWebModule)
    ...
    ServerEntidadeProduto: TDSServerClass;
    ...
    procedure ServerEntidadeProdutoGetClass(DSServerClass: TDSServerClass;
      var PersistentClass: TPersistentClass);
...
procedure TWebModule1.ServerEntidadeProdutoGetClass(
  DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
begin
  PersistentClass := DS.View.Entidade.Produto.TProduto;
end;
